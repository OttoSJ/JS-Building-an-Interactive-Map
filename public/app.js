...
marker.addTo(myMap).bindPopup("<Testing").openPopup()
...
let polygon = L.polygon(langs, {color: "blue", fill: false}).addTo(myMap)
...
const red = L.marker([48.866200610611926, 2.352236247419453],{icon: redPin}).bindPopup('Réaumur-Sébastopol')
